...
<div class="row">
    ...
    <c:set var="paymentRecepiUrl" value="${fn:replace(silentOrderPageData.parameters['orderPage_receiptResponseURL'], 'localhost', url)}"/>
<%-- 	${paymentRecepiUrl } --%>
                        ...
                        <div class="checkout-indent">
                            ...
                            <div class="headline"><spring:theme code="checkout.multi.paymentMethod"/></div>
								...
								<form:form id="silentOrderPostForm" name="silentOrderPostForm" commandName="sopPaymentDetailsForm" action="${paymentFormUrl}" method="POST">
									<input type="hidden" name="orderPage_receiptResponseURL" value="${paymentRecepiUrl}"/>

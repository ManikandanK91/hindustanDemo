 ...
 */
package com.hybris.hindustanpencils.storefront.controllers.pages;
...
import com.hybris.hindustanpencils.storefront.controllers.ControllerConstants;
...
public class QuickOrderPageController extends AbstractPageController
{
	...
	public String getQuickOrderPage(final Model model) throws CMSItemNotFoundException // NOSONAR
	{
		...
		model.addAttribute("quickOrderMinRows", Integer.valueOf(Config.getInt("hindustanpencilsstorefront.quick.order.rows.min", 3)));
		model.addAttribute("quickOrderMaxRows", Integer.valueOf(Config.getInt("hindustanpencilsstorefront.quick.order.rows.max", 25)));

 ...
 */
package com.hybris.hindustanpencils.test.setup;
...
import com.hybris.hindustanpencils.test.constants.HindustanpencilsTestConstants;
import com.hybris.hindustanpencils.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = HindustanpencilsTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/hindustanpencilstest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/hindustanpencilstest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/hindustanpencilstest/import/cstickets.impex");
			...
			importImpexFile(context, "/hindustanpencilstest/import/csquotes.impex");
		}
	}
}

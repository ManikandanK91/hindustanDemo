...
import com.hybris.hindustanpencils.fulfilmentprocess.test.actions.TestActionTemp;
...
public class PaymentIntegrationTest extends ServicelayerTest
{
	...
	public static void prepare() throws Exception //NOPMD
	{
		...
		xmlReader.loadBeanDefinitions(new ClassPathResource(
				"/hindustanpencilsfulfilmentprocess/test/hindustanpencilsfulfilmentprocess-spring-test.xml"));
		xmlReader.loadBeanDefinitions(new ClassPathResource(
				"/hindustanpencilsfulfilmentprocess/test/hindustanpencilsfulfilmentprocess-spring-test-fraudcheck.xml"));
		xmlReader
				.loadBeanDefinitions(new ClassPathResource("/hindustanpencilsfulfilmentprocess/test/process/order-process-spring.xml"));
		...
		definitonFactory.add("classpath:/hindustanpencilsfulfilmentprocess/test/process/payment-process.xml");
	...
	public void setUpProductCatalogue()
	{
		try
		{
			...
			importCsv("/hindustanpencilsfulfilmentprocess/test/testBasics.csv", "windows-1252");
			importCsv("/hindustanpencilsfulfilmentprocess/test/testCatalog.csv", "windows-1252");
	...
	public static void removeProcessDefinitions()
	{
		...
		final XmlBeanDefinitionReader xmlReader = new XmlBeanDefinitionReader((BeanDefinitionRegistry) beanFactory);
		xmlReader.loadBeanDefinitions(new ClassPathResource(
				"/hindustanpencilsfulfilmentprocess/test/hindustanpencilsfulfilmentprocess-spring-testcleanup.xml"));

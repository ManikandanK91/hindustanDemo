 ...
 */
package com.hybris.hindustanpencils.fulfilmentprocess.test.actions.consignmentfulfilment;
...
public abstract class AbstractTestConsActionTemp extends TestActionTemp
{
	...
	{
		final String parentCode = (String) getProcessParameterValue(process, HindustanpencilsFulfilmentProcessConstants.PARENT_PROCESS);

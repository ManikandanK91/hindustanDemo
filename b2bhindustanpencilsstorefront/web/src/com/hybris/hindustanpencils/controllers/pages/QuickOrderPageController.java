 ...
 */
package com.hybris.hindustanpencils.controllers.pages;
...
import com.hybris.hindustanpencils.controllers.ControllerConstants;
...
public class QuickOrderPageController extends AbstractPageController
{
	...
	public String getQuickOrderPage(final Model model) throws CMSItemNotFoundException // NOSONAR
	{
		...
		model.addAttribute("quickOrderMinRows", Integer.valueOf(Config.getInt("b2bhindustanpencilsstorefront.quick.order.rows.min", 3)));
		model.addAttribute("quickOrderMaxRows", Integer.valueOf(Config.getInt("b2bhindustanpencilsstorefront.quick.order.rows.max", 25)));

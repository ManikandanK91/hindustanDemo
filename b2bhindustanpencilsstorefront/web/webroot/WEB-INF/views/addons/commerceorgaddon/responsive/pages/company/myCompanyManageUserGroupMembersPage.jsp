...
<template:page pageTitle="${pageTitle}">
	...
	<script id="enableDisableLinksTemplate" type="text/x-jquery-tmpl">
		{{if selected}}
			<a href="#" url="${actionLink}/deselect/?user={{= encodeURIComponent(uid)}}&usergroup=${ycommerce:encodeUrl(param.usergroup)}" class="action-links js-deselectUser"><span class="glyphicon glyphicon-ok"></span></a>
		{{else}}
		<a href="#" url="${actionLink}/select/?user={{= encodeURIComponent(uid)}}&usergroup=${ycommerce:encodeUrl(param.usergroup)}" class="action-links js-selectUser"><span class="glyphicon glyphicon-ok"></span></a>
		{{/if}}
	</script>

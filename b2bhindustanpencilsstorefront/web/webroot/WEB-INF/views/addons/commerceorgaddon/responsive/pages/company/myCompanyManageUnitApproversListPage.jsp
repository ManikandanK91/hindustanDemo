...
<template:page pageTitle="${pageTitle}">
    ...
    <script id="enableDisableLinksTemplate" type="text/x-jquery-tmpl">
        {{if selected}}
            <a href="#" url="${approversActionLink}/deselect/?user={{= encodeURIComponent(id)}}&unit=${ycommerce:encodeUrl(param.unit)}" class="action-links js-deselectUser"><span class="glyphicon glyphicon-ok"></span></a>
        {{else}}
            <a href="#" url="${approversActionLink}/select/?user={{= encodeURIComponent(id)}}&unit=${ycommerce:encodeUrl(param.unit)}" class="action-links js-selectUser"><span class="glyphicon glyphicon-ok"></span></a>
        {{/if}}
    </script>

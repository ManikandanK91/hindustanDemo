...
<template:page pageTitle="${pageTitle}">
    ...
    {{if active}}
		{{if selected}}
			<a href="#" url="${budgetsActionLink}/deselect/?budgetCode={{= encodeURIComponent(id)}}&costCenterCode=${ycommerce:encodeUrl(param.costCenterCode)}" class="action-links js-deselectBudget"><span class="glyphicon glyphicon-ok"></span></a>
		{{else}}
			<a href="#" url="${budgetsActionLink}/select/?budgetCode={{= encodeURIComponent(id)}}&costCenterCode=${ycommerce:encodeUrl(param.costCenterCode)}" class="action-links js-selectBudget"><span class="glyphicon glyphicon-ok"></span></a>
		{{/if}}
		{{else}}
	{{/if}}
    </script>

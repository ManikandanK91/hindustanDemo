...
<template:page pageTitle="${pageTitle}">
    ...
    <script id="enableDisableLinksTemplate" type="text/x-jquery-tmpl">
        {{if selected}}
        <a href="#" url="${actionLink}/deselect/?approver={{= encodeURIComponent(id)}}&user=${ycommerce:encodeUrl(param.user)}" class="action-links js-deselectUser"><span class="glyphicon glyphicon-ok"></span></a>
        {{else}}
        <a href="#" url="${actionLink}/select/?approver={{= encodeURIComponent(id)}}&user=${ycommerce:encodeUrl(param.user)}" class="action-links js-selectUser"><span class="glyphicon glyphicon-ok"></span></a>
        {{/if}}
    </script>
</template:page>